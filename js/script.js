...
// Startne countdown když se stránka otebře
...
document.getElementById('rezervaceForm').addEventListener('submit', function(e) {
    ...
    // Zkontroluje jestli check out je po check inu
    ...
    if (isValid) {
        // V reálném webu by tohle poslalo info na server
...
// Nastaví minimlní datum na check in jako dnes
document.getElementById('checkin').min = new Date().toISOString().split('T')[0];

// Upraví minimální check out datum když se změní check in
